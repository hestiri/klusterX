...
source("/PHShome/he079/workspace/DQe_p/reqs/load.R")
...
klust <- function(data,
  ...
  #     
  #     method <- c("pam_kluster")
  #     ptime <- c(tpam_kluster/iter_klust)
  #     k_mean <- c(m_pam_k)
  #     k_freq <- c(f_pam_k)
  #     
  #     
  ...
  #       
  #       method <- c("cal_kluster")
  #       ptime <- c(tcal_kluster/iter_klust)
  #       k_mean <- c(m_cal_k)
  #       k_freq <- c(f_cal_k)
  #       
  #       sim <- data.frame(method,k_mean,k_freq,ptime)
  ...
  #         
  #         method <- c("ap_kluster")
  #         ptime <- c(tap_kluster/iter_klust)
  #         k_mean <- c(m_ap_k)
  #         k_freq <- c(f_ap_k)
  #         
  #         
  ...
  #               dat2 <- data[sample(nrow(data), smpl, replace=TRUE), ]
  #               tic()
  #               kbics2[[i]] <- dim(Mclust(as.matrix(dat2), G=3:15)$z)[2]
  #               t1i <- toc()
  #               t1[[i]] <- t1i$toc - t1i$tic
  #               
  #               tic()
  ...
  #           ptime <- c(tBIC_kluster/iter_klust,tpam_kluster/iter_klust,tap_kluster/iter_klust)
